...
function main()
    ...
    script_message('IAH Reloaded 1.0-RC (26-11-2020) by mhertz загружен!')
    ...
    if file then
        ...
        if not doesDirectoryExist('moonloader/config/IAH2/verbose') then createDirectory("moonloader/config/IAH2/verbose") end
        script_message('Настройки загружены!')
        file:close()
    end
...
function imgui.OnDrawFrame()
    ...
    if main_window_state.v then
        ...
        imgui.Begin(u8'Настройки IAH (ver 1.0-RC)', main_window_state)
